 ...
 * Generated from rx-provider-lookup.html by scripts/build-embed.js — do not hand-edit.
 *
...
// Output field-key mapping.
//   *_json    -> dedicated machine-readable fields (for HealthSherpa / automation)
//   *_summary -> the client's EXISTING 🏥 Prescriptions / 🏥 Doctors large-text
//                fields, so agents see a readable list in the contact record.
// Summary keys VERIFIED against the live LPI location (2026-06-11):
//   🏥 Prescriptions → key "medications"   (NOT "prescriptions")
//   🏥 Doctors       → key "doctors"
// Override at runtime (before the embed loads) via:
//   window.RX_CONFIG = { fieldKeys: { medications_summary: 'medications' } };
const FIELD_KEYS = Object.assign({
  medications_json:    'medications_json',
  medications_summary: 'medications',
  providers_json:      'providers_json',
  providers_summary:   'doctors'
}, (typeof window !== 'undefined' && window.RX_CONFIG && window.RX_CONFIG.fieldKeys) || {});
